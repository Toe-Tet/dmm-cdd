...
@section('content')
    ...
    <div class="card custom-card" style="padding-bottom: 20px;">
        ...
        <h5 style="padding-left: 20px; padding-top: 5px;"><b>Staff Edit</b></h5>
        <hr>
        <form action="{{ route('staffs.update', $staff->id) }}" method="POST" enctype="multipart/form-data" id="app">
            @csrf @method('PATCH')
            <div class="row container">
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="container form-group row" style="margin-top: 10px;">
                        ...
                        <div class="col-sm-8">
                            <input type="text" value="{{ $staff->login_name }}" class="form-control form-control-sm" name="login_name" required>
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="container form-group row" style="margin-top: 10px;">
                        ...
                        <div class="col-sm-8">
                            <input type="text" value="{{ $staff->full_name }}" class="form-control form-control-sm" name="full_name" required>
            ...
            <div class="row container">
                <div class="col-md-6 col-sm-12">
                    <div class="container form-group row" style="margin-top: 10px;">
                        ...
                        <div class="col-sm-8">
                            <input type="number" value="{{ $staff->phone_no }}" class="form-control form-control-sm number" name="phone_no" required>
                        ...
                        <div class="col-sm-8">
                            <select name="type" class="form-control form-control-sm" id="">
                                @foreach(config('staff.types') as $value => $type)
                                    <option value="{{ $value }}" {{ $staff->type == $value ? 'selected' : '' }}>{{ $type }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('type'))
            ...
            <div class="row container">
                <div class="col-md-6 col-sm-12">
                    <div class="container form-group row" style="margin-top: 10px;">
                        ...
                        <div class="col-sm-8">
                            <input type="text" value="{{ $staff->gate }}" class="form-control form-control-sm" name="gate">
                            @if($errors->has('gate'))
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="container form-group row" style="margin-top: 10px;">
                        ...
                        <div class="col-sm-8">
                            <textarea class="form-control form-control-sm" name="address">{{ $staff->address }}</textarea>

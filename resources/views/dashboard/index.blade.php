            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="card border-primary">
                  <div class="card-body">
                    <div class="row mt-3">
                        <div class="col-6"><h5 class="card-title pro_light"><i class="fa fa-user"></i> &nbsp; Users</h5></div>
                        <div class="col-6"><h4 class="card-title text-center">{{ $cdds['users_total'] }}</h4></div>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="card border-success">
                  <div class="card-body">
                    <div class="row mt-3">
                        <div class="col-6"><h5 class="card-title pro_light"><i class="fa fa-user-tie"></i> &nbsp; Agents</h5></div>
                        <div class="col-6"><h4 class="card-title text-center">{{ $cdds['agents_total'] }}</h4></div>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 mt-4">
                <div class="card border-warning">
                  <div class="card-body">
                    <div class="row mt-3">
                        <div class="col-6"><h5 class="card-title pro_light"><i class="fa fa-user-secret"></i> &nbsp; Super Agents</h5></div>
                        <div class="col-6"><h4 class="card-title text-center">{{ $cdds['super_agents_total'] }}</h4></div>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 mt-4">
                <div class="card border-danger">
                  <div class="card-body">
                    <div class="row mt-3">
                        <div class="col-6"><h5 class="card-title pro_light"><i class="fa fa-user-secret"></i> &nbsp; Transactions</h5></div>
                        <div class="col-6"><h4 class="card-title text-center">{{ $cdds['transaction_total'] }}</h4></div>
                    </div>
                  </div>
                </div>
              </div>

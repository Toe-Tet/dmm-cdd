...
<link href="{{ asset('/assets/template/vendor/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet">
  ...
  <link href="{{ asset('/assets/template/vendor/font-awesome/css/font-awesome.min.css') }}" rel="stylesheet" type="text/css">

  <!-- Custom styles for this template-->
  <link href="{{ asset('/assets/template/css/sb-admin.css') }}" rel="stylesheet">

  <!-- Styles for Datatable-->
  {{--<link href="/assets/template/vendor/datatables/dataTables.bootstrap4.css" rel="stylesheet">--}}
  {{--<link rel="stylesheet" href="/assets/template/vendor/datatables/jquery.dataTables.min.css">--}}
  ...
  <script src="{{ asset('/assets/template/js/jquery-3.3.1.min.js') }}" type="text/javascript"></script>
